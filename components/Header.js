...
export  default function Header(){
    ...
    return (
            <header id={styles.header} className={styles[open]}>
                <h1 className={styles.headerTitle}>Higienização Profissional</h1>
                <div id={styles.overlay}  data-close="menu" className={styles[open]} onClick={handleClick} ></div>
                <Link href="/">
                    <a title="Valentini Shopping Center"><img src="/images/logo.png" id={styles.logo}  className={styles[open]} alt="Logo" /></a>
                </Link>
